...
const columns: Column<FooterContent>[] = [
  { header: 'Brand Text', accessor: 'brandText', className: 'font-semibold text-navy max-w-[280px] truncate' },
  { header: 'Phone', accessor: 'phone', className: 'max-w-[160px] truncate' },
    ...
    <div className="flex flex-col gap-5 flex-1 min-h-0">
      <div className="flex items-center justify-between gap-4 flex-wrap">
        <p className="text-text-secondary text-sm font-[family-name:var(--font-poppins)]">
          {data
            ? 'Edit the footer content that appears on the website (brand, links, contacts).'
